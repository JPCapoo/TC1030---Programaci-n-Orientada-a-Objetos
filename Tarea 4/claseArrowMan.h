...
class ArrowMan: public Personaje, Arco{
    private: //Atributos
        int numflechas;
        bool dispararflechas;
    public: //Métodos
        ArrowMan(); //Default Constructor
        ArrowMan(string, int, int, int, int, string, int, int, bool); //Constructor
        void shoot();
...
ArrowMan::ArrowMan(string nI, int nL, int n, int c, int s, string nomItem, int nivArco, int nf, bool df): Personaje(nI, nL, n, c, s), Arco(nomItem, nivArco){
    numflechas = nf;
    dispararflechas = df;
};
